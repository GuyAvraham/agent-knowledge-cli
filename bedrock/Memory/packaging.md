...
Current: **0.4.12** (tagged `v0.4.12`). PyPI package name: `project-bedrock`. See [[deployments]].
...
- 2026-05-18: v0.4.11 — remaining `read_text()` calls switched to explicit UTF-8 reads, completing the packaging-side Windows text-encoding cleanup.
- 2026-05-18: v0.4.12 — includes the Bedrock cockpit cleanup work: active `bedrock/` vault trimmed to relevant data, legacy captures/outputs removed from tracked state, and release metadata realigned with the latest pushed code.
